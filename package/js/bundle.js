(function () {
    ...
    /* src/main/routes/Pomodoro.svelte generated by Svelte v3.7.1 */

    const file = "src/main/routes/Pomodoro.svelte";

    function create_fragment(ctx) {
    	var div1, div0, t0_value = ctx.time? `${ctx.time.minutes} : ${ctx.time.seconds}`: '', t0, t1, button, dispose;
    	...
    	return {
    		...
    		l: function claim(nodes) {
    			...
    			button = claim_element(div1_nodes, "BUTTON", {}, false);
    		...
    		h: function hydrate() {
    			add_location(div0, file, 15, 4, 326);
    			add_location(button, file, 16, 4, 389);
    			add_location(div1, file, 14, 0, 316);
    			dispose = listen(button, "click", ctx.timer.start);
    		},
    		...
    		p: function update(changed, ctx) {
    			if ((changed.time) && t0_value !== (t0_value = ctx.time? `${ctx.time.minutes} : ${ctx.time.seconds}`: '')) {
    ...
    function instance($$self, $$props, $$invalidate) {
        ...
        let timer = new CountDownTimer(FIVE_MINS_IN_SECONDS);
        let time = {};
        
        timer.onTick(()=>{
            $$invalidate('time', time = timer.format());
        });
        $$invalidate('time', time = timer.format());
    ...
    const file$1 = "src/main/components/Page.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		...
    		h: function hydrate() {
    			...
    			add_location(div, file$1, 3, 0, 70);
    		},
    ...
    /* src/main/routes/Profile.svelte generated by Svelte v3.7.1 */

    const file$2 = "src/main/routes/Profile.svelte";
    ...
    function create_default_slot(ctx) {
    	...
    	return {
    		...
    		h: function hydrate() {
    			attr(div, "class", "main svelte-1azrxhc");
    			add_location(div, file$2, 10, 4, 299);
    		},
